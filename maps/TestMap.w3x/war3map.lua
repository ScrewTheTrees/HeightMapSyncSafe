...
function main()
    SetCameraBounds(-32256.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -27904.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 27648.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 32256.0 - GetCameraMargin(CAMERA_MARGIN_TOP), -32256.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 32256.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 27648.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -27904.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
